...
function getRegexForGuid() {
  return /{3F2504E0-4F89-41D3-9A0C-0305E82C3301}|{21EC2020-3AEA-4069-A2DD-08002B30309D}|{0c74f13f-fa83-4c48-9b33-68921dd72463}/;
}
...
function getPasswordValidator(minLength) {
  const flags = 'g';
  return new RegExp(`(?=^.{${minLength},}$)(?=.*[0-9])(?=.*[A-Z])(?=.*[a-z])(?=.*[A-Za-z0-9]$).*`, flags);
}
